...
export const mockComplianceItems: ComplianceItem[] = [
  {
    ...
    details: 'R2.9 ceiling and R1.5 underfloor insulation installed',
    remediation: null,
  ...
  },
  {
    ...
    lastChecked: '2024-09-15',
    nextCheckDue: '2025-09-15',
    details: 'Heat pump installed in living area',
    remediation: null,
    evidence: [],
  },
  {
    ...
    lastChecked: '2024-09-15',
    nextCheckDue: '2025-09-15',
    details: 'Extractor fans operational in kitchen and bathroom',
    remediation: null,
    evidence: [],
  },
  {
    ...
    lastChecked: '2024-09-15',
    nextCheckDue: '2025-09-15',
    details: 'No moisture issues, drainage functioning properly',
    remediation: null,
    evidence: [],
  },
  {
