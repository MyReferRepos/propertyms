...
export const navigationItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        title: 'Audit Logs',
        titleKey: 'nav.accounting.auditLogs',
        href: '/accounting/audit/logs',
        icon: History,
      },
      {
        title: 'Compliance Reports',
        titleKey: 'nav.accounting.complianceReports',
        href: '/accounting/audit/reports',
        icon: FileCheck,
      },
      {
        title: 'Change Tracking',
        titleKey: 'nav.accounting.changeTracking',
        href: '/accounting/audit/changes',
        icon: GitCompare,
      },
      {
        title: 'Financial Audit',
        titleKey: 'nav.accounting.financialAudit',
