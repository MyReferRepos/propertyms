...
export function PropertyDetailPage() {
  ...
  const property = mockPropertyData[propertyId as keyof typeof mockPropertyData]
    ...
    <div className="space-y-6">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                <Badge variant="outline" className={statusColors[property.status]}>
                  {property.status === 'occupied' ? 'Occupied' : property.status === 'available' ? 'Available' : 'Maintenance'}
                </Badge>
              </div>
            </div>
          </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">${property.weeklyRent}</div>
            <p className="text-xs text-muted-foreground">${(property.weeklyRent * 52).toLocaleString()}/year</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{property.financials.yieldPercentage}%</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">${(property.currentValue / 1000).toFixed(0)}k</div>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="text-sm font-medium">{property.floorArea}m² Floor</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                ...
                <div className="pt-4 border-t space-y-2">
                  <div className="flex justify-between">
                    ...
                    <span className="text-sm font-medium">${property.purchasePrice.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm text-muted-foreground">Current Value</span>
                    <span className="text-sm font-medium">${property.currentValue.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-lg font-bold text-green-600">${property.financials.totalIncome.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm font-medium">Total Expenses</span>
                    <span className="text-lg font-bold text-red-600">${property.financials.totalExpenses.toLocaleString()}</span>
                  </div>
                  <div className="pt-2 border-t">
                    <div className="flex justify-between items-center">
                      <span className="text-sm font-medium">Net Income</span>
                      <span className="text-xl font-bold">${property.financials.netIncome.toLocaleString()}</span>
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  {property.financials.expenses.map((expense, idx) => (
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{property.tenant.phone}</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 pt-4 border-t">
                  <div>
                    ...
                    <p className="font-medium">{new Date(property.tenant.leaseStart).toLocaleDateString('en-NZ')}</p>
                  </div>
                  <div>
                    <p className="text-sm text-muted-foreground">Lease End</p>
                    <p className="font-medium">{new Date(property.tenant.leaseEnd).toLocaleDateString('en-NZ')}</p>
                  </div>
                  <div>
                    <p className="text-sm text-muted-foreground">Weekly Rent</p>
                    <p className="font-medium">${property.tenant.weeklyRent}</p>
                  </div>
                  <div>
                    <p className="text-sm text-muted-foreground">Bond Amount</p>
                    <p className="font-medium">${property.tenant.bondAmount}</p>
                  </div>
        ...
        <TabsContent value="compliance" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2">
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  {Object.entries(property.compliance.healthyHomes).map(([key, value]) => (
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="text-sm font-medium">{property.compliance.insurance.provider}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm text-muted-foreground">Policy Number</span>
                  <span className="text-sm font-medium">{property.compliance.insurance.policyNumber}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm text-muted-foreground">Cover Amount</span>
                  <span className="text-sm font-medium">${property.compliance.insurance.coverAmount.toLocaleString()}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm text-muted-foreground">Expiry Date</span>
                  <span className="text-sm font-medium">{new Date(property.compliance.insurance.expiryDate).toLocaleDateString('en-NZ')}</span>
                </div>
                <Button variant="outline" className="w-full mt-4">
